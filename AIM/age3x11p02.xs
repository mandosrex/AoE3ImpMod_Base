...
/* age3x11p02.xs
   ...
   This is a standard AI.  One of 3 "parallel" AI's.  Each is handicapped. This is computer player 2, Sioux.
   Created 3-13-06.  JSB.
*/
//==============================================================================
...
void postInit(void)
{
   ...
   kbSetPlayerHandicap(cMyID,kbGetPlayerHandicap(cMyID)*0.88);  // Handicap him, since the player must fight three AI's. 
